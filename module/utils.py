...
def test_accuracy(net, test_loader, num_data = 1000, label = 0, get_quanti = None, net_ori = None, loss_dict=None, test_mode=False, interpreter_list=None, interpreter_list2=None):
    ...
    if test_mode:
        return (test_acc1 / 1000), (test_acc5 / 1000), loss_dict
    else:
