        ...
        for i, data in enumerate(train_loader):
            ...
            if itr % args.eval_period  == 0:
                ...
                if args.imagenet_accuracy:
                    test_acc1, test_acc5, loss_dict = test_accuracy(net, test_loader, num_data=1000, get_quanti ='loss', loss_dict = loss_dict, net_ori = net_ori, test_mode=True, interpreter_list=interpreter_list)
